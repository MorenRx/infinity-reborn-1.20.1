ServerEvents.tags('item', event => {
    event.add('tiered:weapon_star_1', [
    ...
    event.add('tiered:weapon_star_2', [
		...
		'mcdw:hammer_gravity', 'mcdw:hammer_stormlander', 'mcdw:scythe_jailors_scythe', 'mcdw:sickle_last_laugh_gold',
    ...
    event.add('tiered:weapon_star_3', [
		...
		'mcdw:gauntlet_soul_fists', 'mcdw:scythe_frost_scythe', 'mcdw:sickle_nightmares_bite', 'mcdw:dagger_eternal_knife', 'mcdw:sword_truthseeker',
		'mythicmetals:metallurgium_sword', 'twilightforest:giant_sword', 'twilightforest:fiery_sword', 'twilightforest:glass_sword'
	])
	
    event.add('tiered:weapon_star_4', [
		'mcdw:sword_obsidian_claymore', 'mcdw:sword_dark_katana', 'mcdw:sword_sinister', 'mcdw:sword_frost_slayer',
		'mcdw:hammer_suns_grace', 'mcdw:spear_whispering_spear', 'mcdw:scythe_skull_scythe', 'mcdw:glaive_grave_bane',
		'mcdw:scythe_soul_scythe', 'mcdw:sword_masters_katana', 'gobber2:gobber2_sword_nether', 'botania:terra_sword',
		...
		'gateofbabylon:terra_spear', 'gateofbabylon:nether_gobber_broadsword', 'gateofbabylon:terra_broadsword', 'gateofbabylon:nether_gobber_rapier',
		'gateofbabylon:terra_rapier', 'soulsweapons:darkin_blade'
	])
	
    event.add('tiered:weapon_star_5', [
		...
		'gateofbabylon:end_gobber_broadsword', 'gateofbabylon:end_gobber_rapier', 'gateofbabylon:end_gobber_haladie', 'gateofbabylon:end_gobber_waraxe',
	...
	event.add('tiered:ranged_star_3', [
	...
	event.add('tiered:ranged_star_4', [
	...
	event.add('tiered:ranged_star_5', [
	...
	event.add('tiered:ranged_star_6', [
	...
	event.add('tiered:helmet_star_5', [
	...
	event.add('tiered:chestplate_star_5', [
	...
	event.add('tiered:leggings_star_5', [
	...
	event.add('tiered:tool_terra', [
		'botania:terra_pick'
	])
	
	event.add('tiered:mu_jian', [
		'kubejs:mu_jian', 'kubejs:yuan_mu_jian'
	])
})
